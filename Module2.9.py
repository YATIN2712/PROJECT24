# -*- coding: utf-8 -*-
"""
Created on Fri Feb  9 14:58:49 2024
...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  9 14:51:29 2024
...
def t_BEGINTABLE(t):
    r'<h3><span.class="mw-headline".id="1_September">1.September</span></h3>'
    return t
...
def main():
    file_obj = open('sep2020.html', 'r', encoding="utf-8")
    data = file_obj.read()
    lexer = lex.lex()
    lexer.input(data)
    for tok in lexer:
    ...
    def extract_data(parser):
        ...
        with open('sep2020.txt', 'w') as file:
            file.write(text)
    # Menu loop
    while True:
        print("\nMenu:")
