# -*- coding: utf-8 -*-
"""
Created on Sat Mar  2 16:13:50 2024
...
def t_BEGINTABLE(t):
    r'<h3><span.class="mw-headline".id="1_November">1.November</span></h3>'
    return t
...
def main():
    file_obj = open('nov2020.html', 'r', encoding="utf-8")
    data = file_obj.read()
    lexer = lex.lex()
    lexer.input(data)
    for tok in lexer:
    ...
    def extract_data(parser):
        ...
        with open('nov2020.txt', 'w') as file:
            file.write(text)
    # Menu loop
    while True:
        print("\nMenu:")
