# -*- coding: utf-8 -*-
"""
Created on Fri Feb  9 14:13:45 2024
...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb  9 14:05:22 2024
...
def t_BEGINTABLE(t):
    r'<h3><span.class="mw-headline".id="1_June">1.June</span></h3>'
    return t
...
def main():
    file_obj = open('jun2020.html', 'r', encoding="utf-8")
    data = file_obj.read()
    lexer = lex.lex()
    lexer.input(data)
    for tok in lexer:
    ...
    def extract_data(parser):
        ...
        with open('jun2020.txt', 'w') as file:
            file.write(text)
    # Menu loop
    while True:
        print("\nMenu:")
