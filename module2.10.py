# -*- coding: utf-8 -*-
"""
Created on Wed Feb 28 13:51:43 2024
...
def t_BEGINTABLE(t):
    r'<h3><span.class="mw-headline".id="1_October">1.October</span></h3>'
    return t
...
def main():
    file_obj = open('oct2020.html', 'r', encoding="utf-8")
    data = file_obj.read()
    lexer = lex.lex()
    lexer.input(data)
    for tok in lexer:
    ...
    def extract_data(parser):
        ...
        with open('oct2020.txt', 'w') as file:
            file.write(text)
    # Menu loop
    while True:
        print("\nMenu:")
